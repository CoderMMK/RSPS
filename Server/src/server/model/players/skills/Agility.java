...
public class Agility {
	...
	private void agilityWalk(final Client c, final int walkAnimation,
	...
	public void agilityCourse(final Client c, final int objectType) {
		...
		case 2295:
			...
			CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
				...
				public void stop() {
					resetAgilityWalk(c);
					c.getPA().addSkillXP((int) 7.5 * Config.AGILITY_EXPERIENCE,
							c.playerAgility);
					logBalance = true;
					doingAgility = false;
				}
		...
		case 2313:
			...
			c.getPA()
					.addSkillXP(5 * Config.AGILITY_EXPERIENCE, c.playerAgility);
			treeBranchUp = true;
			break;
		case 2312:
			doingAgility = true;
			...
			CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
				...
				public void stop() {
					resetAgilityWalk(c);
					c.getPA().addSkillXP(7 * Config.AGILITY_EXPERIENCE,
							c.playerAgility);
					balanceRope = true;
					doingAgility = false;
				}
		...
		case 2286:
			...
			CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
				...
				public void stop() {
					...
					c.getPA().addSkillXP(8 * Config.AGILITY_EXPERIENCE,
							c.playerAgility);
		...
		case 4058:
			...
			CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
				...
				public void stop() {
					...
					resetAgilityWalk(c);
					if (logBalance && obstacleNetUp && treeBranchUp
							&& balanceRope && treeBranchDown && obstacleNetOver) {
						c.getPA().addSkillXP(47 * Config.AGILITY_EXPERIENCE,
								c.playerAgility);
